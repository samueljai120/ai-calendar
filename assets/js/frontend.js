jQuery(document).ready(function($) {
    ...
    class AiCalendar {
        ...
        renderCalendar() {
            ...
            // Get localized weekday names - reuse existing weekday headers
            const weekdays = [];
            this.$container.find('.weekday-header .weekday').each(function() {
                weekdays.push($(this).text());
            });
            
            // Clear the current grid
            const $calendarGrid = this.$container.find('.calendar-grid');
            $calendarGrid.empty();
            ...
            for (let day = 1; day <= numDays; day++) {
                ...
                $calendarGrid.append(`
                    <div class="day-container${isToday ? ' today' : ''}" data-date="${dateStr}">
                        <div>
            ...
            const totalDays = firstDayOfWeek + numDays;
